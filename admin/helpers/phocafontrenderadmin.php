...
class PhocaFontRenderAdmin
{
	...
	public static function getLinks() {
		...
		switch ($option) {
			...
			case 'com_phocafont':
				$links[]	= array('Phoca Font site', 'https://www.phoca.cz/phocafont');
				$links[]	= array('Phoca Font documentation site', 'https://www.phoca.cz/documentation/category/55-phoca-font-component');
				$links[]	= array('Phoca Font download site', 'https://www.phoca.cz/download/category/82-phoca-font');
			break;
