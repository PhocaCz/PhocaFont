...
echo '<div class="btn-group ph-cp-btn-update"><a class="btn btn-large btn-info" href="https://www.phoca.cz/phocafont-fonts" target="_blank"><i class="icon-share icon-white"></i>&nbsp;&nbsp;'.  Text::_($this->t['l'] . '_CHECK_AVAILABLE_FONTS') .'</a></div>';
