	...
	echo $class::quickIconButton( $linkV, 'icon-48-'.$k.'.png', JText::_($v), $this->t['i']);
		...
		<div class="ph-cpanel-right">
			<div class="well">
                ...
                <?php echo '<div class="ph-cpanel-logo">'.JHtml::_('image', 'media/com_phocafont/images/administrator/logo-phoca-font.png', 'Phoca.cz') . '</div>'; ?>
...
.'<div class="btn-group" style="float:left;"><a class="btn btn-large btn-primary" href="https://www.phoca.cz/version/index.php?phocafont='.  $this->t['version'] .'" target="_blank"><i class="icon-loop icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_FOR_UPDATE') .'</a></div>';
...
echo '<div style="float:left; margin: 30px 10px 10px 10px"><a href="https://www.phoca.cz/" target="_blank">'.JHTML::_('image', $this->t['i'] . 'logo.png', 'Phoca.cz' ).'</a></div>';
