...
echo '<div id="j-main-container" class="span9">'
	...
	.'<h3>'.JText::_($this->t['l'].'_PHOCA_FONT').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
	.'<div style="clear:both;"></div>';

echo '<h3>'.  JText::_($this->t['l'].'_HELP').'</h3>';

echo '<p>'
.'<a href="http://www.phoca.cz/phocafont/" target="_blank">Phoca Font Main Site</a><br />'
.'<a href="http://www.phoca.cz/documentation/" target="_blank">Phoca Font User Manual</a><br />'
...
echo '<div class="btn-group" style="float:left;"><a class="btn btn-large btn-primary" href="http://www.phoca.cz/version/index.php?phocafont='.  $this->t['version'] .'" target="_blank"><i class="icon-loop icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_FOR_UPDATE') .'</a></div>';

echo '<div class="btn-group" style="float:left;"><a class="btn btn-large btn-info" href="http://www.phoca.cz/phocafont-fonts" target="_blank"><i class="icon-share icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_AVAILABLE_FONTS') .'</a></div>';
